...
export function MenuToggleIcon({
  ...
  return (
    <svg strokeWidth={strokeWidth} fill={fill} stroke={stroke} viewBox="0 0 32 32"
      ...
      style={{ transitionDuration: `${duration}ms` }} {...props}>
      <path className={cn('transition-all ease-in-out',
