  ...
  return (
    <div className="rounded-2xl bg-white/5 border border-white/10 p-8">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full inline-flex items-center justify-center gap-2 bg-[#2684ef] text-white font-bold px-6 py-4 rounded-xl hover:bg-[#1a74db] transition-colors text-base shadow-lg shadow-[#2684ef]/25"
        >
